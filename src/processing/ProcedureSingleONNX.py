...
def load_model_and_scaler():
    ...
    onnx_model_path = "/home/h3trinh/SE455-Lenovo-Server-Code/src/processing/ML/models/LSTM_4class/test2.onnx"
...
class ProcedureSingleONNX:
    ...
    def __init__(self, dataPath: str):
        ...
        self.pickleList = glob.glob(self.dataPath)*51
        self.files = []
